...
public class LlamasWhalesAndDodosOhMy {
    ...
    public static void main(String[] args) {
        ...
        if( (whales + llamas) < dodos) {
            System.err.println("I never thought I'd see the day when dodos ruled the earth.");
        }
        ...
        // ADDING NEW STATEMENT TO PRINT IF LLAMAS ARE THE LARGER VALUE
